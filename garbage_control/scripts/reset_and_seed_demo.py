...
def run() -> None:
    ...
    organization_specs = [
        ...
        {
            "key": "almet_parks",
            "name": "МБУ Парки и скверы Альметьевска",
            "short_name": "Парки Альметьевска",
            "org_type": "MUNICIPAL_SERVICE",
            "subject": "16",
            "municipality": "almet",
            "locality": "almetyevsk",
            "address": "Альметьевск, ул. Мира, 18",
            "phone": "+7-8553-45-10-06",
            "email": "parks-almet@example.com",
            "is_external": False,
        },
        {
            "key": "almet_ecotrans",
            "name": "ООО ЭкоТранс Сервис",
            "short_name": "ЭкоТранс Сервис",
            "org_type": "CONTRACTOR",
            "subject": "16",
            "municipality": "almet",
            "locality": "almetyevsk",
            "address": "Альметьевск, Монтажная, 7",
            "phone": "+7-8553-45-10-07",
            "email": "ecotrans-almet@example.com",
            "is_external": False,
        },
        {
            "key": "almet_housing",
            "name": "ООО Управляющая компания Комфортный двор",
            "short_name": "УК Комфортный двор",
            "org_type": "PROPERTY_OWNER",
            "subject": "16",
            "municipality": "almet",
            "locality": "almetyevsk",
            "address": "Альметьевск, ул. Шевченко, 61",
            "phone": "+7-8553-45-10-08",
            "email": "comfort-yard@example.com",
            "is_external": True,
        },
        {
            "key": "almet_water",
            "name": "МУП Альметьевск-Водоканал",
            "short_name": "Водоканал Альметьевск",
            "org_type": "OTHER",
            "subject": "16",
            "municipality": "almet",
            "locality": "almetyevsk",
            "address": "Альметьевск, ул. Базовая, 9",
            "phone": "+7-8553-45-10-09",
            "email": "vodokanal-almet@example.com",
            "is_external": False,
        },
        {
            "key": "kazan_service",
    ...
    zone_specs = [
        ...
        ("Парки и скверы Альметьевска", "almet_parks", None, None, "16", "almet", "almetyevsk", "MUNICIPAL_LAND", 52.279, 54.904, 0.020, 0.014, "Городские парки, скверы и пешеходные зеленые зоны."),
        ("Юго-запад Альметьевска", "almet_ecotrans", None, None, "16", "almet", "almetyevsk", "MUNICIPAL_LAND", 52.275, 54.899, 0.018, 0.012, "Подрядное обслуживание дворов и открытых площадок юго-западной части города."),
        ("Жилой фонд Альметьевска", "almet_housing", None, None, "16", "almet", "almetyevsk", "MUNICIPAL_LAND", 52.281, 54.901, 0.022, 0.013, "Дворовые территории и прилегающий жилой фонд управляющей компании."),
        ("Инженерные сети Альметьевска", "almet_water", None, None, "16", "almet", "almetyevsk", "MUNICIPAL_LAND", 52.271, 54.896, 0.017, 0.010, "Зоны обслуживания инженерной и коммунальной инфраструктуры."),
